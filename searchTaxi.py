...
"""
returns coordinates of pickup and dropoff locations from map number
"""
...
def solveTaxi(obs):
    ...
    actions = aStarSearch(pos, pickup)
    actions.append(4) # pickup action
    actions += aStarSearch(pickup, dropoff)
    actions.append(5) # dropoff action
    return actions
